 ...
 */
public class TabInformacionAlmacen extends Fragment {

    private final String TAG = "TabInformacionAlmacen";
   ...
   // private ListView lvAlmacenes;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        viewFrg = inflater.inflate(R.layout.tab_informacion_almacen, container, false);
        context = getActivity();
